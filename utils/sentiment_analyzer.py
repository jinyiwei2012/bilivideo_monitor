...
# ── 情感词典（积极/消极） ─────────────────────────────
_POSITIVE_WORDS = {
    "好", "棒", "赞", "强", "厉害", "优秀", "精彩", "喜欢", "爱", "美",
    "好看", "好听", "好棒", "了不起", "绝了", "神作", "神仙", "大佬",
    "太强了", "感动", "泪目", "震撼", "牛逼", "无敌", "炸裂", "起飞",
    "神", "宝藏", "精品", "良心", "超爱", "好用", "完美", "经典",
    "收藏", "三连", "一键三连", "关注", "投币", "加油", "支持",
}

_NEGATIVE_WORDS = {
    "差", "烂", "垃", "圾", "恶心", "难听", "难看", "无聊", "没意思",
    "浪费", "浪费时间", "垃圾", "不行", "不好", "失望", "差评", "反感",
    "作呕", "低俗", "垃圾中的战斗机", "水", "灌水", "骗", "虚假",
    "抄袭", "盗用", "举报", "取关", "退钱", "尴尬", "无语", "暴躁",
    "生气了", "呵呵", "呵呵哒", "呸", "糟蹋", "败笔", "烂活",
}

# 程度副词
_INTENSIFIERS = {
    "非常", "很", "太", "超级", "极其", "特别", "十分", "无比", "绝", "极",
    "爆", "死", "疯", "炸", "透", "坏",
}
...
def _tokenize(text: str) -> List[str]:
    ...
    while i < len(text_copy):
        ...
        for length in range(4, 0, -1):
            ...
            if (chunk in _POSITIVE_WORDS or chunk in _NEGATIVE_WORDS
                    or chunk in _INTENSIFIERS or chunk in _NEGATORS):
                tokens.append(chunk)
                i += length
                matched = True
                break

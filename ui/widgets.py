...
class SectionHeader(QWidget):
    ...
    def __init__(self, title: str, subtitle: str = "", parent=None):
        ...
        bar.setStyleSheet(f"background-color: {C['lty_blue']}; border: none; border-radius: 1px;")
        h.addWidget(bar)
...
class EmptyState(QWidget):
    ...
    def __init__(self, text: str = "暂无数据", parent=None):
        ...
        note = QLabel("♪")
        note.setStyleSheet(f"color: {C['lty_blue']}; font-size: 30px; background: transparent;")

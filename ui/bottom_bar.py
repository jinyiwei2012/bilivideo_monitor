...
class BottomBar:
    ...
    def _build_bottom_bar(self):
        ...
        ctk.CTkButton(
            bar, text="＋ 添加监控",
            fg_color=C["bilibili"], hover_color=C["bilibili_dim"],
            text_color="#ffffff", font=FONT, corner_radius=6,
            height=32, command=self.gui._add_monitor,
        ).pack(side=tk.LEFT, padx=(12, 4), pady=8)

        ctk.CTkButton(
            bar, text="🔄 立即刷新",
            fg_color=C["bg_elevated"], hover_color=C["bg_hover"],
            text_color=C["text_2"], font=FONT, corner_radius=6,
            height=32, command=self.gui._refresh_data,
        ).pack(side=tk.LEFT, padx=4, pady=8)

        ctk.CTkButton(
            bar, text="🗑 删除监控",
            fg_color="transparent", hover_color=C["bg_hover"],
            text_color=C["danger"], font=FONT, corner_radius=6,
            height=32, border_width=1, border_color=C["danger"],
        ...
        ctk.CTkLabel(ar_f, text="自动刷新", text_color=C["text_2"],
                     font=FONT, fg_color="transparent").pack(side=tk.LEFT, padx=4)
    ...
    def _build_status_bar(self):
        ...
        for key, text in items:
            ...
            lbl = ctk.CTkLabel(bar, text=text, text_color=C["text_3"],
                               font=("Microsoft YaHei UI", 8), fg_color="transparent",
                               anchor=anchor)
